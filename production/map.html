      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index1.html" class="site_title">Gentelella Alela!</a>
          </div>
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index1.html">Dashboard</a>
                    </li>
                ...
                <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="breakfast_menu.html">Tables</a>
                    </li>
                    <li><a href="manage_EV_profiles.html">Table Dynamic</a>
                    </li>
                  </ul>
                </li>
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="request_V2G_Electricity.html">Plain Page</a>
                    </li>
